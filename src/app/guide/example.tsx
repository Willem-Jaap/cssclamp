...
const Example = () => {
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="relative h-full origin-top-left overflow-hidden rounded-lg border border-neutral-700 bg-neutral-800 pt-12 pb-8">
            ...
            <div className="relative mx-auto h-full w-[calc(66.6%+2rem)] origin-top-left overflow-hidden rounded-lg border border-neutral-700 bg-neutral-800 px-4 pt-12 pb-8">
                <div className="absolute top-4 left-4">
                    <div className="flex items-center gap-2">
                        <div className="h-3 w-3 rounded-full bg-red-500" />
                        <div className="h-3 w-3 rounded-full bg-yellow-500" />
            ...
            <div className="relative mx-auto h-full w-1/3 origin-top-left overflow-hidden rounded-lg border border-neutral-700 bg-neutral-800 px-4 pt-12 pb-8">
                <div className="absolute top-4 left-4">
                    <div className="flex items-center gap-2">
                        <div className="h-3 w-3 rounded-full bg-red-500" />
                        <div className="h-3 w-3 rounded-full bg-yellow-500" />
